...
import { Briefcase, Plane, RefreshCcw, TrendingUp, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Tổng hợp số liệu theo thời gian thực • {periodLabel}</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Doanh thu, đơn và đối tác trong kỳ</CardDescription>
          </CardHeader>
            ...
            topPartners.map((partner) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{formatNumber(partner.bookings)} đơn đặt</p>
                </div>
