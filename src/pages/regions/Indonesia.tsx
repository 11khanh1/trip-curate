...
const Indonesia = () => {
  ...
  const cities = [
    { name: "Bali", rank: 1, image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&h=300&fit=crop" },
    { name: "Jakarta", rank: 2, image: "https://images.unsplash.com/photo-1593210891280-67da72c5ee5d?w=400&h=300&fit=crop" },
    { name: "Yogyakarta", rank: 3, image: "https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=400&h=300&fit=crop" },
    { name: "Lombok", image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=300&fit=crop" },
    { name: "Bandung", image: "https://images.unsplash.com/photo-1593210891280-67da72c5ee5d?w=400&h=300&fit=crop" },
    { name: "Surabaya", image: "https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=400&h=300&fit=crop" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=1200&h=400&fit=crop')" }}
      >
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="all" className="w-full">
          ...
          <div className="mt-12 mb-16">
            <h2 className="text-3xl font-bold mb-8">Điểm đến hấp dẫn tại INDONESIA</h2>
